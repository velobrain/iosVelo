...
//table view controller that lists BT devices
class BTmanager: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource {
    //Data
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        //WE DON'T NEED TO GO TO NEW CONTROLLER FOR NOW.
